...
{
    public sealed class TerrainGeneratorV4 : ProceduralGenerator<ZoneDNA, TerrainGenerationResult>
    {
        public static readonly GeneratorVersion GeneratorVersion = new GeneratorVersion(4);
        ...
        public TerrainGeneratorV4(TerrainGenerationConfig config, BiomeDefinition biome, ZoneFeaturePlan features) : base(GeneratorVersion)
        {
        ...
        protected override GenerationValidation ValidateCore(ZoneDNA dna, GenerationContext context)
        {
            ...
            if (dna.TerrainProfileId != TerrainProfileId.RollingLowPoly) return GenerationValidation.Invalid("TERRAIN_PROFILE_UNSUPPORTED", "TerrainGeneratorV4 supports RollingLowPoly only.");
